        ...
        <div class="content_wrapper">
            ...
            <div id="content_area">
                <div id="packages_box">
                    ...
                    <br>
                    <table id="guides" style=' align="center" bgcolor="#EEE0CB"'>
                        <tr style ='align="center" bgcolor="#5FCEE8"'>
                            <th id="thfix">Name</th>
                        ...
                        while ($row_c = mysqli_fetch_array($run_c)) {
                            ...
                            <tr style='align="left"'>
                                ...
                                <td style="width: 240px;" style='align="center"'><?php echo $e_address; ?></td>
                    ...
                    <br><br><br>
                    <h3 style="font-family: Cambria;font-size: 25px;">Head Office:</h3>
                    <p id="headoff"  style="font-family: Cambria;font-size: 20px;"><b>Address: </b>Sinhgad College of Engineering, Vadgaon, Pune.<br>
